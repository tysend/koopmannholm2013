...
Even 95% power would be within budget but due to recruitment plans I will need to collect and pay for data from approximately 80 participants.

###Planned Sample

Those ~80 participants will be recruited on MTurk in two groups: Meditators and Nonmeditators where meditators are defined by Koopmann-Holm et al. as participants "who [have] been practicing Buddhist-inspired meditation [e.g., mindfullness, compassion meditation] for at least one year" and non meditators are defined as those who "did not practice any form of meditation."
